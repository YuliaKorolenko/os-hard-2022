...
Гибридные системы – основные службы выполняются в режиме монолитного ядра. Наш выбор! Потому что можно обеспечиват какую-то безопасность и не терять в скорости сильно. Компоненты могут быть включены или отключены во время компиляции. Поддержка загружаемых модулей ядра (во время выполнения). Организуйте ядро в логические независимые подсистемы. Строгие интерфейсы, но с низкими затратами на производительность: макросы, встроенные
функции, указатели функций.
